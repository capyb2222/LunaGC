...
import emu.grasscutter.net.proto.ActivityShopSheetInfo;
import emu.grasscutter.net.proto.GetActivityShopSheetInfoRsp;
        ...
        if (sheetInfo == null || activityConfigItem == null) {
            setData(
                    GetActivityShopSheetInfoRsp.newBuilder()
                            ...
                            .setRetcode(Retcode.RET_SHOP_NOT_OPEN_VALUE)
                            .build());
            return;
        }
