...
import emu.grasscutter.net.proto._MapLayerInfo;
import emu.grasscutter.net.proto.PlayerWorldSceneInfoListNotify;
import emu.grasscutter.net.proto.PlayerWorldSceneInfo;
        ...
        for (int scene : GameData.getSceneDataMap().keySet()) {
            ...
            if (scene == 3) {
                worldInfoBuilder.setMapLayerInfo(
                        _MapLayerInfo.newBuilder()
                                .addAllIMIKDGJJBHA(GameData.getMapLayerFloorDataMap().keySet())
                                .addAllUnlockedLayerGroupList(
