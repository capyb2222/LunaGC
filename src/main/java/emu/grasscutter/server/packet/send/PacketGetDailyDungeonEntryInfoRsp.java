...
public class PacketGetDailyDungeonEntryInfoRsp extends BasePacket {
    ...
    public PacketGetDailyDungeonEntryInfoRsp(Integer sceneID) {
        ...
        var resp = GetDailyDungeonEntryInfoRsp.newBuilder();
    ...
    private DailyDungeonEntryInfo getDungonEntryInfo(
        ...
        DungeonEntryInfo dungeonEntryInfo =
                DungeonEntryInfo.newBuilder().setDungeonId(130).build();

        var builder = DailyDungeonEntryInfo.newBuilder();
