...
import emu.grasscutter.net.proto.CombatInvocationsNotify;
import emu.grasscutter.net.proto.CombatInvokeEntry;
import emu.grasscutter.net.proto.EntityMoveInfo;
import emu.grasscutter.net.proto.EvtAnimatorParameterInfo;
import emu.grasscutter.net.proto.EvtBeingHitInfo;
            ...
            switch (entry.getArgumentType()) {
                ...
                case ENTITY_MOVE -> {
                    ...
                    if (entity != null
                        ...
                        if (motionState == MotionState.MOTION_STATE_MOTION_LAND_SPEED) {
                        ...
                        if (monitorLandingEvent) {
                            if (motionState == MotionState.MOTION_STATE_MOTION_FALL_ON_GROUND) {
                        ...
                        // will be interrupted
                        if (motionState == MotionState.MOTION_STATE_MOTION_NOTIFY
                                || motionState == MotionState.MOTION_STATE_MOTION_FIGHT) {
                            continue;
                        }
                    }
                }
    ...
    private void handleFallOnGround(GameSession session, GameEntity entity, MotionState motionState) {
        ...
        if (newHP == 0) {
            session
                    .getPlayer()
                    .getStaminaManager()
                    .killAvatar(session, entity, PlayerDieType.PLAYER_DIE_PLAYER_DIE_FALL);
        }
