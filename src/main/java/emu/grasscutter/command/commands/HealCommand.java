                        ...
                        entity -> {
                            ...
                            entity.setFightProperty(
                                   ...
                                   if (entity.getFightProperty(FightProperty.FIGHT_PROP_CUR_HP_DEBTS) > 0) {
                                    ...
                                    entity.getWorld().broadcastPacket(new PacketEntityFightPropChangeReasonNotify(entity, FightProperty.FIGHT_PROP_CUR_HP_DEBTS, 0f, PropChangeReason.PROP_CHANGE_REASON_PROP_CHANGE_NONE,
