...
import emu.grasscutter.net.proto.MotionState;
import emu.grasscutter.net.proto.PlayerDieType;
import emu.grasscutter.net.proto.Vector;
import emu.grasscutter.net.proto.VehicleInteractType;
...
public class StaminaManager extends BasePlayerManager {
    ...
    private static final Map<String, Set<MotionState>> MotionStatesCategorized = new HashMap<>() {{
        put("CLIMB", Set.of(
            MotionState.MOTION_STATE_MOTION_CLIMB, // sustained, when not moving no cost no recover
            MotionState.MOTION_STATE_MOTION_STANDBY_TO_CLIMB // NOT OBSERVED, see MOTION_JUMP_UP_WALL_FOR_STANDBY
        ));
        put("DASH", Set.of(
            MotionState.MOTION_STATE_MOTION_DANGER_DASH, // sustained
            MotionState.MOTION_STATE_MOTION_DASH // sustained
        ));
        put("FLY", Set.of(
            MotionState.MOTION_STATE_MOTION_FLY, // sustained
            MotionState.MOTION_STATE_MOTION_FLY_FAST, // sustained
            MotionState.MOTION_STATE_MOTION_FLY_SLOW, // sustained
            MotionState.MOTION_STATE_MOTION_POWERED_FLY // sustained, recover
        ));
        put("RUN", Set.of(
            MotionState.MOTION_STATE_MOTION_DANGER_RUN, // sustained, recover
            MotionState.MOTION_STATE_MOTION_RUN // sustained, recover
        ));
        put("SKIFF", Set.of(
            MotionState.MOTION_STATE_MOTION_SKIFF_BOARDING, // NOT OBSERVED even when boarding
            MotionState.MOTION_STATE_MOTION_SKIFF_DASH, // sustained, observed with waverider entity ID.
            MotionState.MOTION_STATE_MOTION_SKIFF_NORMAL, // sustained, OBSERVED when both normal and dashing
            MotionState.MOTION_STATE_MOTION_SKIFF_POWERED_DASH // sustained, recover
        ));
        put("STANDBY", Set.of(
            MotionState.MOTION_STATE_MOTION_DANGER_STANDBY_MOVE, // sustained, recover
            MotionState.MOTION_STATE_MOTION_DANGER_STANDBY, // sustained, recover
            MotionState.MOTION_STATE_MOTION_LADDER_TO_STANDBY, // NOT OBSERVED
            MotionState.MOTION_STATE_MOTION_STANDBY_MOVE, // sustained, recover
            MotionState.MOTION_STATE_MOTION_STANDBY // sustained, recover
        ));
        put("SWIM", Set.of(
            MotionState.MOTION_STATE_MOTION_SWIM_IDLE, // sustained
            MotionState.MOTION_STATE_MOTION_SWIM_DASH, // immediate and sustained
            MotionState.MOTION_STATE_MOTION_SWIM_JUMP, // NOT OBSERVED
            MotionState.MOTION_STATE_MOTION_SWIM_MOVE // sustained
        ));
        put("WALK", Set.of(
            MotionState.MOTION_STATE_MOTION_DANGER_WALK, // sustained, recover
            MotionState.MOTION_STATE_MOTION_WALK // sustained, recover
        ));
        put("OTHER", Set.of(
            MotionState.MOTION_STATE_MOTION_CLIMB_JUMP, // cost only once if repeated without switching state
            MotionState.MOTION_STATE_MOTION_DASH_BEFORE_SHAKE, // immediate one time sprint charge.
            MotionState.MOTION_STATE_MOTION_FIGHT, // immediate, if sustained then subsequent will be MOTION_NOTIFY
            MotionState.MOTION_STATE_MOTION_JUMP_UP_WALL_FOR_STANDBY, // immediate, observed when RUN/WALK->CLIMB
            MotionState.MOTION_STATE_MOTION_NOTIFY, // can be either cost or recover - check previous state and check skill casting
            MotionState.MOTION_STATE_MOTION_SIT_IDLE, // sustained, recover
            MotionState.MOTION_STATE_MOTION_JUMP // recover
        ));
        put("NOCOST_NORECOVER", Set.of(
            MotionState.MOTION_STATE_MOTION_LADDER_SLIP, // NOT OBSERVED
            MotionState.MOTION_STATE_MOTION_SLIP, // sustained, no cost no recover
            MotionState.MOTION_STATE_MOTION_FLY_IDLE // NOT OBSERVED
        ));
        put("IGNORE", Set.of(
            // these states have no impact on stamina
            MotionState.MOTION_STATE_MOTION_CROUCH_IDLE,
            MotionState.MOTION_STATE_MOTION_CROUCH_MOVE,
            MotionState.MOTION_STATE_MOTION_CROUCH_ROLL,
            MotionState.MOTION_STATE_MOTION_DESTROY_VEHICLE,
            MotionState.MOTION_STATE_MOTION_FALL_ON_GROUND,
            MotionState.MOTION_STATE_MOTION_FOLLOW_ROUTE,
            MotionState.MOTION_STATE_MOTION_FORCE_SET_POS,
            MotionState.MOTION_STATE_MOTION_GO_UPSTAIRS,
            MotionState.MOTION_STATE_MOTION_JUMP_OFF_WALL,
            MotionState.MOTION_STATE_MOTION_LADDER_IDLE,
            MotionState.MOTION_STATE_MOTION_LADDER_MOVE,
            MotionState.MOTION_STATE_MOTION_LAND_SPEED,
            MotionState.MOTION_STATE_MOTION_MOVE_FAIL_ACK,
            MotionState.MOTION_STATE_MOTION_NONE,
            MotionState.MOTION_STATE_MOTION_NUM,
            MotionState.MOTION_STATE_MOTION_QUEST_FORCE_DRAG,
            MotionState.MOTION_STATE_MOTION_RESET,
            MotionState.MOTION_STATE_MOTION_STANDBY_TO_LADDER,
            MotionState.MOTION_STATE_MOTION_WATERFALL
        ));
    }};
    ...
    private MotionState currentState = MotionState.MOTION_STATE_MOTION_STANDBY;
    private MotionState previousState = MotionState.MOTION_STATE_MOTION_STANDBY;
    ...
    public void handleVehicleInteractReq(GameSession session, int vehicleId, VehicleInteractType vehicleInteractType) {
        if (vehicleInteractType == VehicleInteractType.VEHICLE_INTERACT_TYPE_VEHICLE_INTERACT_IN) {
    ...
    private void handleDrowning() {
        ...
        if (stamina < 10) {
            ...
            if (currentState != MotionState.MOTION_STATE_MOTION_SWIM_IDLE) {
                killAvatar(cachedSession, cachedEntity, PlayerDieType.PLAYER_DIE_PLAYER_DIE_DRAWN);
            }
        }
    }
    ...
    private Consumption getClimbConsumption() {
        ...
        if (currentState == MotionState.MOTION_STATE_MOTION_CLIMB && isPlayerMoving()) {
    ...
    private Consumption getSwimConsumptions() {
        handleDrowning();
        Consumption consumption = new Consumption();
        if (currentState == MotionState.MOTION_STATE_MOTION_SWIM_MOVE) {
            consumption.type = ConsumptionType.SWIMMING;
            consumption.amount = ConsumptionType.SWIMMING.amount;
        }
        if (currentState == MotionState.MOTION_STATE_MOTION_SWIM_DASH) {
    ...
    private Consumption getDashConsumption() {
        Consumption consumption = new Consumption();
        if (currentState == MotionState.MOTION_STATE_MOTION_DASH) {
    ...
    private Consumption getFlyConsumption() {
        ...
        if (currentState == MotionState.MOTION_STATE_MOTION_POWERED_FLY) {
    ...
    private Consumption getSkiffConsumption() {
        ...
        return switch (currentState) {
            case MOTION_STATE_MOTION_SKIFF_DASH -> new Consumption(ConsumptionType.SKIFF_DASH);
            case MOTION_STATE_MOTION_SKIFF_POWERED_DASH -> new Consumption(ConsumptionType.POWERED_SKIFF);
            case MOTION_STATE_MOTION_SKIFF_NORMAL -> new Consumption(ConsumptionType.SKIFF);
            default -> new Consumption();
        };
    }
    ...
    private Consumption getOtherConsumptions() {
        return switch (this.currentState) {
            default -> new Consumption();
            case MOTION_STATE_MOTION_FIGHT -> new Consumption(ConsumptionType.FIGHT, 500);
            case MOTION_STATE_MOTION_NOTIFY -> new Consumption(ConsumptionType.NOTIFY);
        };
    }
