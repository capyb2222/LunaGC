...
import emu.grasscutter.net.proto.AnnounceData;
...
public class AnnouncementSystem extends BaseGameSystem {
    ...
    public void broadcast(List<AnnounceConfigItem> tpl) {
        ...
        var list =
                tpl.stream()
                        ...
                        .map(AnnounceData.Builder::build)
                        .toList();
    ...
    public class AnnounceConfigItem {
        ...
        public AnnounceData.Builder toProto() {
            var proto = AnnounceData.newBuilder();
            ...
            if (type == AnnounceType.CENTER) {
                proto.setCAIKIDFANHN(content);
            } else {
                proto.setIHGDLEJOPFC(content);
            }
