...
import emu.grasscutter.net.proto.AbilityEmbryo;
...
import emu.grasscutter.net.proto.EntityClientData;
...
import emu.grasscutter.net.proto.SceneAvatarInfo;
...
public class EntityAvatar extends GameEntity {
    ...
    public void onDeath(int killerId) {
        ...
        this.killedType = PlayerDieType.PLAYER_DIE_PLAYER_DIE_KILL_BY_MONSTER;
        this.killedBy = killerId;
        clearEnergy(ChangeEnergyReason.CHANGE_ENERGY_REASON_CHANGE_ENERGY_NONE);
    }
            ...
            getScene()
                    .broadcastPacket(
                            new PacketEntityFightPropChangeReasonNotify(
                                    ...
                                    ChangHpReason.CHANG_HP_REASON_CHANGE_HP_SUB_ABILITY));
        }
    ...
    public void clearEnergy(ChangeEnergyReason reason) {
        ...
        if (reason == ChangeEnergyReason.CHANGE_ENERGY_REASON_CHANGE_ENERGY_SKILL_START) {
            this.getScene()
                    .broadcastPacket(
