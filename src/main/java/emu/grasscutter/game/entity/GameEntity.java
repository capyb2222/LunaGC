...
import emu.grasscutter.net.proto.FightPropPair;
...
// REMOVED IN 6.6: PropChangeDetailInfo
...
public abstract class GameEntity {
    ...
    // @Setter private PropChangeDetailInfo propChangeDetailInfo; // REMOVED IN 6.6
    ...
    public GameEntity(Scene scene) {
        this.scene = scene;
        this.motionState = MotionState.MOTION_STATE_MOTION_NONE;
    }
        ...
        if (toRepay > 0) {
            ...
            if (this.getFightProperty(FightProperty.FIGHT_PROP_CUR_HP_DEBTS) > 0) {
                this.getScene().broadcastPacket(new PacketEntityFightPropChangeReasonNotify(this, FightProperty.FIGHT_PROP_CUR_HP_DEBTS, toRepay,
                                                        mute
                                                                ? PropChangeReason.PROP_CHANGE_REASON_PROP_CHANGE_NONE
                                                                : PropChangeReason.PROP_CHANGE_REASON_PROP_CHANGE_ABILITY,

                                                        _ChangeHpDebtsReason._CHANGE_HP_DEBTS_REASON_CHANGE_HP_DEBTS_PAY
                ));
            } else {
                this.getScene().broadcastPacket(new PacketEntityFightPropChangeReasonNotify(this, FightProperty.FIGHT_PROP_CUR_HP_DEBTS, toRepay,
                                                        mute
                                                        ...
                                                        _ChangeHpDebtsReason._CHANGE_HP_DEBTS_REASON_CHANGE_HP_DEBTS_PAY_FINISH
                                                       ));
            }
        }
    ...
    public void damage(float amount, int killerId, ElementType attackType) {
        this.damage(amount, 0, attackType, PropChangeReason.PROP_CHANGE_REASON_PROP_CHANGE_NONE, ChangHpReason.CHANG_HP_REASON_CHANGE_HP_NONE);
    }
    ...
    public void checkIfDead() {
        ...
        if (this.getFightProperty(FightProperty.FIGHT_PROP_CUR_HP) <= 0f) {
            ...
            if (debt >= 0) {
                ...
                this.getScene().broadcastPacket(new PacketEntityFightPropUpdateNotify(this, FightProperty.FIGHT_PROP_CUR_HP_DEBTS));
                this.getScene().broadcastPacket(new PacketEntityFightPropChangeReasonNotify(this, FightProperty.FIGHT_PROP_CUR_HP_DEBTS, -debt, PropChangeReason.PROP_CHANGE_REASON_PROP_CHANGE_ABILITY, _ChangeHpDebtsReason._CHANGE_HP_DEBTS_REASON_CHANGE_HP_DEBTS_CLEAR));
            }
            this.isDead = true;
        }
    }
