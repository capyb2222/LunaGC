...
import static emu.grasscutter.net.proto.MailItem.newBuilder;

import dev.morphia.annotations.*;
import emu.grasscutter.database.DatabaseHelper;
import emu.grasscutter.game.player.Player;
import emu.grasscutter.net.proto.*;
import emu.grasscutter.net.proto.EquipParam;
import emu.grasscutter.net.proto.MailCollectState;
import emu.grasscutter.net.proto.MailTextContent;
...
public final class Mail {
    ...
    public MailData toProto(Player player) {
        return MailData.newBuilder()
                ...
                .setCollectState(MailCollectState.MAIL_COLLECT_STATE_MAIL_NOT_COLLECTIBLE)
                .build();
    }
    ...
    public static class MailItem {
        ...
        public emu.grasscutter.net.proto.MailItem toProto() {
            return emu.grasscutter.net.proto.MailItem.newBuilder()
                    .setEquipParam(
