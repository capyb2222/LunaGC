...
import emu.grasscutter.net.proto.BargainResultType;
import emu.grasscutter.net.proto.BargainSnapshot;
...
public final class BargainRecord {
    ...
    public BargainResultType applyOffer(int offer) {
        if (offer < this.getLowestPrice()) {
            ...
            // Return a failure.
            return this.result = BargainResultType.BARGAIN_RESULT_TYPE_BARGAIN_SINGLE_FAIL;
        }
        ...
        if (offer > this.getExpectedPrice()) {
            ...
            // Return a success.
            return this.result = BargainResultType.BARGAIN_RESULT_TYPE_BARGAIN_COMPLETE_SUCC;
        }
    ...
    public BargainSnapshot toSnapshot() {
        return BargainSnapshot.newBuilder()
                ...
                .setKEEMGGOIPHF(this.getExpectedPrice())
                .setMOKENFKKOEP(this.getLowestPrice())
                .build();
    }
}
