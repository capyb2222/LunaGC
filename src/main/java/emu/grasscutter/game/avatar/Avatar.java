...
import emu.grasscutter.net.proto.AvatarFetterInfo;
import emu.grasscutter.net.proto.AvatarInfo;
import emu.grasscutter.net.proto.AvatarSkillInfo;
import emu.grasscutter.net.proto.FetterData;
import emu.grasscutter.net.proto.GrantReason;
import emu.grasscutter.net.proto.ShowAvatarInfo;
import emu.grasscutter.net.proto.ShowEquip;
import emu.grasscutter.net.proto.TrialAvatarGrantRecord;
import emu.grasscutter.net.proto.TrialAvatarInfo;
...
public class Avatar {
    ...
    @Getter @Setter
    private int grantReason = GrantReason.GRANT_REASON_INVALID.getNumber();
    ...
    public void setTrialAvatarInfo(
        int level, int avatarId, GrantReason grantReason, int questId) {
        this.setLevel(level);
