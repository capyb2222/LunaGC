...
import emu.grasscutter.net.proto.BattlePassCycle;
import emu.grasscutter.net.proto.BattlePassRewardTakeOption;
import emu.grasscutter.net.proto.BattlePassSchedule;
import emu.grasscutter.net.proto.BattlePassUnlockStatus;
            ...
            for (var option : rewardList) {
                ...
                BattlePassReward bpReward =
                        new BattlePassReward(
                                tag.getLevel(),
                                tag.getRewardId(),
                                tag.getUnlockStatus() == BattlePassUnlockStatus.BATTLE_PASS_UNLOCK_PAID);
    ...
    public BattlePassSchedule getScheduleProto() {
        ...
        BattlePassSchedule.Builder schedule =
                BattlePassSchedule.newBuilder()
                        ...
                        .setUnlockStatus(
                                this.isPaid()
                                        ? BattlePassUnlockStatus.BATTLE_PASS_UNLOCK_PAID
                                        : BattlePassUnlockStatus.BATTLE_PASS_UNLOCK_FREE)
                        .setCurCycle(
