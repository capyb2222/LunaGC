...
import emu.grasscutter.net.proto.DealAddFriendResultType;
...
public class FriendsList extends BasePlayerManager {
    ...
    public synchronized void handleFriendRequest(int targetUid, DealAddFriendResultType result) {
        ...
        // Handle
        if (result == DealAddFriendResultType.DEAL_ADD_FRIEND_RESULT_TYPE_DEAL_ADD_FRIEND_ACCEPT) { // Request accepted
