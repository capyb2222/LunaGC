...
public class World implements Iterable<Player> {
    ...
    public boolean transferPlayerToScene(
        ...
        if (dungeonData != null) {
            ...
            teleportProps.enterType(EnterType.ENTER_DUNGEON).enterReason(EnterReason.DungeonEnter);
            ...
            // Home
            teleportProps.enterType(EnterType.ENTER_SELF_HOME).enterReason(EnterReason.EnterHome);
        }
