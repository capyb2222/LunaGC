...
import emu.grasscutter.net.proto.InvestigationMonster;
...
public class WorldDataSystem extends BaseGameSystem {
    ...
    private InvestigationMonster getInvestigationMonster(
    ...
    public List<InvestigationMonster> getInvestigationMonstersByCityId(
