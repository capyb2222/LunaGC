...
import emu.grasscutter.net.proto.VisionType;
...
public class Scene {
    ...
    public synchronized void removePlayer(Player player) {
        ...
        this.getEntities().values().stream()
                ...
                .forEach(entityVehicle -> this.removeEntity(entityVehicle, VisionType.VISION_REMOVE));
    ...
    private synchronized void removePlayerAvatars(Player player) {
        ...
        // removeEntities(team, VisionType.VISION_REMOVE);  // List<SubType> isn't cool apparently
        // :(
        team.forEach(e -> removeEntity(e, VisionType.VISION_REMOVE));
        team.clear();
    }
    ...
    public synchronized void replaceEntity(EntityAvatar oldEntity, EntityAvatar newEntity) {
        ...
        this.broadcastPacket(
                new PacketSceneEntityDisappearNotify(oldEntity, VisionType.VISION_REPLACE));
        this.broadcastPacket(
                new PacketSceneEntityAppearNotify(
                        newEntity, VisionType.VISION_REPLACE, oldEntity.getId()));
    }
    ...
    public void handleAttack(AttackResult result) {
        ...
        GameEntity target = getEntityById(result.getONMNILILOAJ());
    ...
    public void selectWorktopOptionWith(SelectWorktopOptionReq req) {
        ...
        if (entity instanceof EntityGadget gadget) {
            if (gadget.getContent() instanceof GadgetWorktop worktop) {
                ...
                if (shouldDelete) {
                    entity.getScene().removeEntity(entity, VisionType.VISION_REMOVE);
                }
            }
        }
    }
