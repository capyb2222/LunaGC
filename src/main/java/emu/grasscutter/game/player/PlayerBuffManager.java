...
import emu.grasscutter.net.proto.ServerBuffChangeNotify.ServerBuffChangeType;
import emu.grasscutter.net.proto.ServerBuff;
...
public final class PlayerBuffManager extends BasePlayerManager {
        ...
        getPlayer()
                .sendPacket(
                        new PacketServerBuffChangeNotify(
                                getPlayer(),
                                ServerBuffChangeType.DEL_SERVER_BUFF,
                                this.buffs.values()));
    ...
    public synchronized boolean addBuff(int buffId, float duration, Avatar target) {
        ...
        getPlayer()
                .sendPacket(
                        new PacketServerBuffChangeNotify(
                                getPlayer(), ServerBuffChangeType.ADD_SERVER_BUFF, buff));
    ...
    public synchronized boolean removeBuff(int buffGroupId) {
        ...
        if (buff != null) {
            getPlayer()
                    .sendPacket(
                            new PacketServerBuffChangeNotify(
                                    getPlayer(), ServerBuffChangeType.DEL_SERVER_BUFF, buff));
            return true;
        }
