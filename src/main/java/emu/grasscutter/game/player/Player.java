...
import emu.grasscutter.net.proto.AttackResult;
import emu.grasscutter.net.proto.CombatInvokeEntry;
import emu.grasscutter.net.proto.AbilityScalarValueEntry;
import emu.grasscutter.net.proto.GadgetInteractReq;
import emu.grasscutter.net.proto.MpSettingType;
import emu.grasscutter.net.proto.OnlinePlayerInfo;
import emu.grasscutter.net.proto.*;
import emu.grasscutter.net.proto.PlayerLocationInfo;
...
public class Player implements PlayerHook, FieldFetch {
    ...
    @Getter private transient MpSettingType mpSetting = MpSettingType.MP_SETTING_TYPE_MP_SETTING_ENTER_AFTER_APPLY;
            ...
            if (this.getShowAvatarList() != null) {
                for (int avatarId : this.getShowAvatarList()) {
                    socialShowAvatarInfoList.add(
                        ...
                        SocialShowAvatarInfo.newBuilder()
    ...
    private boolean expireEnterHomeRequest(EnterHomeRequest req, boolean force) {
        ...
        req.getRequester().sendPacket(new PacketPlayerApplyEnterHomeResultNotify(
            ...
            this.getNickname(),
            false,
            PlayerApplyEnterHomeResultNotify.Reason.SYSTEM_JUDGE));
