...
public final class ActionReviveElemEnergy extends AbilityActionHandler {
    ...
    public boolean execute(
        ...
        if (target instanceof EntityAvatar avatar) {
            ...
            avatar.getScene().broadcastPacket(new PacketEntityFightPropChangeReasonNotify(avatar, avatar.getAvatar().getSkillDepot().getElementType().getCurEnergyProp(), newEnergy, PropChangeReason.PROP_CHANGE_REASON_PROP_CHANGE_ABILITY, ChangeEnergyReason.CHANGE_ENERGY_REASON_CHANGE_ENERGY_ABILITY));
