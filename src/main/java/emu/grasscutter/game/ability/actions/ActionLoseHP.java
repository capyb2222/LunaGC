...
public final class ActionLoseHP extends AbilityActionHandler {
    ...
    public boolean execute(
        ...
        target.getWorld().broadcastPacket(new PacketEntityFightPropChangeReasonNotify(target, FightProperty.FIGHT_PROP_CUR_HP, -amountToLose, PropChangeReason.PROP_CHANGE_REASON_PROP_CHANGE_ABILITY, ChangHpReason.CHANG_HP_REASON_CHANGE_HP_SUB_ABILITY));
