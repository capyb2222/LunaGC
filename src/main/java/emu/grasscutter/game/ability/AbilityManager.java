...
import emu.grasscutter.net.proto.AbilityMetaAddSpecialEnergyValue;
...
import emu.grasscutter.net.proto.AbilityMetaAddAbility;
import emu.grasscutter.net.proto.AbilityMetaModifierChange;
import emu.grasscutter.server.packet.send.PacketMonsterSummonTagNotify;
import emu.grasscutter.net.proto.AbilityMetaReInitOverrideMap;
import emu.grasscutter.net.proto.AbilityMetaSetKilledState;
import emu.grasscutter.net.proto.AbilityScalarValueEntry;
import emu.grasscutter.net.proto.ModifierAction;
...
public final class AbilityManager extends BasePlayerManager {
    ...
    public void onAbilityInvoke(AbilityInvokeEntry invoke) throws Exception {
        ...
        switch (invoke.getArgumentType()) {
            ...
            // case ABILITY_MIXIN_CHANGE_PHLOGISTON -> this.handleMixinChangePhlogiston(invoke);
            ...
            case ABILITY_META_ADD_SPECIAL_ENERGY_VALUE -> this.handleAddSpecialEnergy(invoke);
    ...
    private void handleAddSpecialEnergy(AbilityInvokeEntry invoke) throws InvalidProtocolBufferException {
        var head = invoke.getHead();
        AbilityMetaAddSpecialEnergyValue abilityMetaSpecialEnergy = AbilityMetaAddSpecialEnergyValue.parseFrom(invoke.getAbilityData());
        var entity = this.player.getScene().getEntityById(invoke.getEntityId());
        if (entity == null) {
        ...
        float specialEnergyAdd = abilityMetaSpecialEnergy.getSpecialEnergyDelta();
    ...
    //     AbilityMixinChangePhlogiston abilityMixinChangePhlogiston = AbilityMixinChangePhlogiston.parseFrom(invoke.getAbilityData());
    //     var head = invoke.getHead();
