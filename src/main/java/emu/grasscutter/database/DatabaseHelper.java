...
public final class DatabaseHelper {
    ...
    /**
     * Returns any one account in the database, or null if none exist. Used as a fallback for
     * logins whose credentials can't be decrypted (e.g. when the client patch hasn't swapped the
     * SDK RSA key on a newer game version).
     */
    public static Account getFirstAccount() {
        return DatabaseManager.getAccountDatastore().find(Account.class).first();
    }
