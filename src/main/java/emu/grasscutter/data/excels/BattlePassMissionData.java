...
import emu.grasscutter.net.proto.BattlePassMission.MissionStatus;
import java.util.*;
...
public class BattlePassMissionData extends GameResource {
    ...
    public emu.grasscutter.net.proto.BattlePassMission toProto() {
        var protoBuilder =
                emu.grasscutter.net.proto.BattlePassMission.newBuilder();
